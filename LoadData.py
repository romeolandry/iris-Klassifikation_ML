...
class LoadData:
    ...
    def match_classe_numeric(self,data_train):
        ...
        for key in self.__dict_match:
            data_train.loc[data_train['variety'] == value,'variety']=key
    ...
    def create_train_test(self,data_matrix,percent):      
        ...
        X_train,X_test,y_train,y_test = train_test_split(data_matrix[:,:4],data_matrix[:,4], test_size=percent)
